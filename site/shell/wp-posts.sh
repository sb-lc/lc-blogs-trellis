...
sudo -u vagrant -i -- wp --path=$1 post delete $(sudo -u vagrant -i -- wp post list --post_type=page --posts_per_page=1 --post_status=publish --pagename="sample-page" --field=ID --format=ids)
